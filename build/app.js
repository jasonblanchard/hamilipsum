...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createElement(
	  _reactRouter.Route,
	  { path: '/' },
	  _react2.default.createElement(_reactRouter.Route, { path: '/:amount/:unit', component: _app2.default }),
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: 'https://github.com/jasonblanchard/hamilipsum', target: '_blank' },
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: 'http://about.blanktech.net/#/about', target: '_blank' },
	          'Jason Blanchard'
	        ),
	        ', a big fan of ',
	        _react2.default.createElement(
	          'a',
	          { href: 'https://www.youtube.com/channel/UCKhSqWRvBtjlivrs_xeT5aQ/videos', target: '_blank' },
	          'Hamilton'
	        ),
	        '. Credit where credit\'s due: idea and interface inspired by ',
	        _react2.default.createElement(
	          'a',
	          { href: 'http://littleipsum.com/', target: '_blank' },
	          'LittleIpsum'
	        ),
	        ' and ',
	        _react2.default.createElement(
	          'a',
	          { href: 'http://hipsum.co/', target: '_blank' },
	          'Hipster Ipsum'
	        ),
	        '.'
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pluralize = __webpack_require__(221);
	...
	var _hamilipsum = __webpack_require__(225);

	var _hamilipsum2 = _interopRequireDefault(_hamilipsum);

	var _lodash = __webpack_require__(233);

	var _lodash2 = _interopRequireDefault(_lodash);

	var _TextSelector = __webpack_require__(237);

	var _TextSelector2 = _interopRequireDefault(_TextSelector);
	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    _this.handleClickDropdown = _this.handleClickDropdown.bind(_this);
	    _this.handleCloseMenu = _this.handleCloseMenu.bind(_this);
	    _this.handleHoverSelection = _this.handleHoverSelection.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      var amount = _props$params.amount;
	      var unit = _props$params.unit;

	      if (amount && unit) {
	        this.setState({
	          text: _hamilipsum2.default.generate(amount, unit)
	        });
	      }
	    }
	  }, {
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      var amount = _nextProps$params.amount;
	      var unit = _nextProps$params.unit;

	      if (!(0, _lodash2.default)(this.props.params, nextProps.params)) {
	        this.setState({
	          text: _hamilipsum2.default.generate(amount, unit)
	        });
	      }
	    ...
	    key: 'handleClickDropdown',
	    value: function handleClickDropdown(event) {
	      event.stopPropagation();
	      this.setState({
	    ...
	    key: 'handleHoverSelection',
	    value: function handleHoverSelection(selection) {
	      this.setState({
	    ...
	    value: function handleClickSelection() {
	      var _state = this.state;
	      var amount = _state.hoverAmount;
	      var unit = _state.hoverUnit;

	      _reactRouter.hashHistory.push(amount + '/' + unit);
	      this.setState({
	        text: _hamilipsum2.default.generate(amount, unit)
	      });
	    }
	    ...
	    value: function renderText() {
	      ...
	      return _react2.default.createElement('div', { className: 'App-text', dangerouslySetInnerHTML: this.formatText(this.state.text) });
	    }
	  }, {
	    key: 'renderSelector',
	    value: function renderSelector() {
	      return _react2.default.createElement(_TextSelector2.default, { amount: this.state.hoverAmount, unit: this.state.hoverUnit, onClickSelection: this.handleClickSelection, onHoverSelection: this.handleHoverSelection });
	    }
	  }, {
	    key: 'renderSelectionLabel',
	    value: function renderSelectionLabel() {
	      var _state2 = this.state;
	      var hoverUnit = _state2.hoverUnit;
	      var hoverAmount = _state2.hoverAmount;

	      return hoverUnit ? hoverAmount + ' ' + (0, _pluralize2.default)(hoverUnit, hoverAmount) : 'Generate';
	    }
	  }, {
	    key: 'renderSelectMode',
	    value: function renderSelectMode() {
	      var amount = this.props.params.amount;
	      if (amount) {
	        return _react2.default.createElement(
	          _Dropdown2.default,
	          { isOpen: this.state.showMenu, onClick: this.handleClickDropdown, buttonText: this.renderSelectionLabel() },
	          this.renderSelector()
	        );
	      }
	      return _react2.default.createElement(
	        'div',
	        { className: 'App-initialSelectContainer' },
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'App', onClick: this.handleCloseMenu },
	        _react2.default.createElement(
	          'h1',
	          null,
	          'Hamil Ipsum'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dropdown = function (_Component) {
	  ...
	  _createClass(Dropdown, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var className = (0, _classnames2.default)('Dropdown', { isOpen: this.props.isOpen });
	      return _react2.default.createElement(
	        'div',
	        { className: className },
	        _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodash5 = __webpack_require__(232);
	...
	function randomIndex() {
	  var index = (0, _lodash4.default)(0, _source2.default.length);
	  return index;
	}

	function generateWords(amount) {
	  var output = (0, _lodash6.default)(amount, function () {
	    return randomIndex();
	  }).map(function (i) {
	    return _source2.default[i];
	  }).join(' ');

	  return (0, _lodash2.default)(output).replace(/^i\s|\si\s|\si$/g, ' I ').replace(/america/g, 'America') + '.';
	}

	function generateSentences(amount) {
	  return (0, _lodash6.default)(amount, function () {
	    var sentenceLength = (0, _lodash4.default)(5, 10);
	...
	function generateParagraph(amount) {
	  return (0, _lodash6.default)(amount, function () {
	    var paragraphLength = (0, _lodash4.default)(3, 10);
	    return generateSentences(paragraphLength) + '\n\n';
	  }).join('');
	}

	exports.default = {
	  generate: function generate(amount, unit) {
	    var output = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toString = __webpack_require__(227),
	    upperFirst = __webpack_require__(229);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextSelector = function (_Component) {
	  _inherits(TextSelector, _Component);

	  function TextSelector(props) {
	    _classCallCheck(this, TextSelector);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TextSelector).call(this, props));
	  ...
	  _createClass(TextSelector, [{
	    key: 'handleHover',
	    value: function handleHover(index, unit) {
	      this.props.onHoverSelection({ amount: index + 1, unit: unit });
	    }
	  }, {
	    key: 'handleHoverOut',
	    ...
	    value: function renderWords() {
	      ...
	      return (0, _lodash2.default)(5, function (index) {
	        var highlighted = _this2.props.unit === 'word' && _this2.props.amount >= index + 1;
	        var className = (0, _classnames2.default)('TextSelector-wordsButton', { 'TextSelector-selected': highlighted });
	        return _react2.default.createElement(
	          'button',
	          { className: className, key: index, onMouseOver: _this2.handleHover.bind(_this2, index, 'word'), onFocus: _this2.handleHover.bind(_this2, index, 'word'), onClick: _this2.handleClick },
	          _react2.default.createElement(
	            'span',
	    ...
	    key: 'renderSentences',
	    value: function renderSentences() {
	      var _this3 = this;

	      return (0, _lodash2.default)(5, function (index) {
	        var highlighted = _this3.props.unit === 'sentence' && _this3.props.amount >= index + 1;
	        var className = (0, _classnames2.default)('TextSelector-sentencesButton', { 'TextSelector-selected': highlighted });
	        return _react2.default.createElement(
	          'button',
	          { className: className, key: index, onMouseOver: _this3.handleHover.bind(_this3, index, 'sentence'), onFocus: _this3.handleHover.bind(_this3, index, 'sentence'), onClick: _this3.handleClick },
	          _react2.default.createElement(
	            'span',
	            { className: 'show-for-sr' },
	            index + 1 + ' word'
	    ...
	    key: 'renderParagraphs',
	    value: function renderParagraphs() {
	      var _this4 = this;

	      return (0, _lodash2.default)(5, function (index) {
	        var highlighted = _this4.props.unit === 'paragraph' && _this4.props.amount >= index + 1;
	        var className = (0, _classnames2.default)('TextSelector-paragraphsButton', { 'TextSelector-selected': highlighted });
	        return _react2.default.createElement(
	          'button',
	          { className: className, key: index, onMouseOver: _this4.handleHover.bind(_this4, index, 'paragraph'), onFocus: _this4.handleHover.bind(_this4, index, 'paragraph'), onClick: _this4.handleClick },
	          _react2.default.createElement(
	            'span',
	            { className: 'show-for-sr' },
	            index + 1 + ' paragraph'
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'TextSelector', onMouseLeave: this.handleHoverOut },
	        _react2.default.createElement(
	          'div',
	          { className: 'TextSelector-words' },
	          this.renderWords()
	        ),
	...
	TextSelector.propTypes = {
	  ...
	  onClickSelection: _react.PropTypes.func.isRequired,
	  onHoverSelection: _react.PropTypes.func.isRequired,
	  unit: _react.PropTypes.string
	};

	TextSelector.defaultProps = {
	  onClickSelection: function onClickSelection() {},
	  onHoverSelection: function onHoverSelection() {}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".TextSelector {\n  width: 100%;\n  max-width: 400px; }\n  .TextSelector button {\n    background: #ABABAB;\n    border: 0; }\n    .TextSelector button:focus {\n      outline: none;\n      box-shadow: 0 0 0 1px #80A1DE; }\n    .TextSelector button.TextSelector-selected {\n      background: #80A1DE; }\n\n.TextSelector-words {\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  margin-bottom: 5px; }\n\n.TextSelector-wordsButton {\n  -webkit-box-flex: 1;\n  -webkit-flex: 1;\n      -ms-flex: 1;\n          flex: 1;\n  margin-right: 8px;\n  height: 15px; }\n  .TextSelector-wordsButton:last-child {\n    margin: 0; }\n\n.TextSelector-sentencesButton, .TextSelector-paragraphsButton {\n  display: block;\n  width: 100%;\n  margin-bottom: 5px;\n  height: 15px; }\n  .TextSelector-sentencesButton:last-child, .TextSelector-paragraphsButton:last-child {\n    margin: 0; }\n\n.TextSelector-paragraphsButton {\n  height: 35px; }\n", ""]);
